                                      ...
                                      <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="card user-card">
                                                    ...
                                                    <?php
												  	$result = $db->prepare("SELECT * FROM fuel where name='$name'");
													$result->execute();
                                                  ...
                                                  <div class="card-block">
                                                   <img src="../v_photo/<?php echo $rows['photo'];?>" alt="img" class="img-fluid" width="100%">
                                                    ...
                                                    <p class="text-muted">Active | <?php echo $rows['cntno1'];?> |<?php echo $rows['cntno2'];?></p>
                                                     <a href="service_update.php<?php echo '?fuel_id='.$fuel_id; ?>" class="btn btn-danger btn-out-dashed btn-block">Update</a>
                                                      <hr>		
