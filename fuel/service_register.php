                                            ...
                                            <!-- Basic Form Inputs card start -->
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="m-b-10">Fuel Station Register</h5>
                                                        
                                                     </div>
                                                     <div class="card-block">
                                                        <form method="post" action="action/fuel_save.php" enctype="multipart/form-data" autocomplete="off">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="cntno1" class="form-control form-control-primary" required pattern="[0-9]{10,10}" maxlength="10" minlength="10">
                                                                </div>
                                                            </div>                                                  
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Contact No</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="cntno2" class="form-control form-control-primary" required pattern="[0-9]{10,10}" maxlength="10" minlength="10">
                                                                </div>
                                                            </div>
                                                             <div class="form-group row">
