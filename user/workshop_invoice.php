                                      ...
                                      <div class="row">
                                            ...
                                            <!-- Basic Form Inputs card start -->
                                                <div class="card">
                                					...
                                					<form method="post" action="workshop_invoice_view.php" autocomplete="off"> 
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Vehicle No</label>
                                                                <div class="col-sm-10">
                                                 <input list="vno" required class="form-control form-control-primary" name="vno" placeholder="Search Vehicle No">
                                                                    <datalist id="vno">
