                                ...
                                <div class="page-wrapper">
                                    <div class="page-body">
                                      <div class="row">
                                            ...
                                            <?php
												$result = $db->prepare("SELECT * FROM vrequest where ULog_Id='$Log_Id' and  vostat='Accept' and rostat='Pending'");
												$result->execute();
                                                  ...
                                                  <div class="card-block">
                                                   <img src="../photo/<?php echo $rows['photo'];?>" alt="img" class="img-fluid" width="100%">
                                                    ...
                                                    <p class="text-muted">Amount <?php echo $rows['amt'];?></p>
                                                     <a href="action/otr_update.php<?php echo '?vreq_id='.$vreq_id; ?>" class="btn btn-danger btn-out-dashed btn-block">Accept</a>                                                                                                       
                                                    </div>
