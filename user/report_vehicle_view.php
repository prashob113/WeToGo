                                            ...
                                            <!-- Basic Form Inputs card start -->
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="m-b-10">Travel Report From  <?php echo $fdate;?> To  <?php echo $tdate;?> Report</h5>
                                						...
                                						<div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <?php
																			$total=0;
																	$result = $db->prepare("select * from vrequest where (ULog_Id='$Log_Id' Or VLog_Id='$Log_Id') and tdate >= '$fdate' AND tdate <= '$tdate' order by tdate asc");
																			$result->execute();
