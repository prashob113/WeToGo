                                                  ...
                                                  <div class="card-block">
                                                   <img src="../v_photo/<?php echo $rows['photo'];?>" alt="img" class="img-fluid" width="100%">
                                                    ...
                                                    <p class="text-muted">Active | <?php echo $rows['vmodel'];?> |<?php echo $rows['vbdate'];?></p>
                                                     <a href="vehicle_update.php<?php echo '?vehi_id='.$vehi_id; ?>" class="btn btn-danger btn-out-dashed btn-block">Update</a>
                                                      <hr>		
                                                     <a href="vehicle_search.php" class="btn btn-info btn-out-dashed btn-block">Back</a>
                                                     <hr/>                                                      
                                                    </div>
